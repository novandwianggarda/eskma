...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li><a href="userr"><i class="fa fa-user"></i> <span>Profil</span></a></li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i> UPP</a></li>
            <li><a href=""><i class="fa fa-circle-o"></i>ODP</a></li>
            <li><a href="kabupaten"><i class="fa fa-circle-o"></i>Kab/Kota</a></li>
          </ul>
        </li>
        <li><a href="berita"><i class="fa fa-book"></i> <span>Berita</span></a></li>
        <li><a href="berita"><i class="fa fa-calendar"></i> <span>Jadwal</span></a></li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="laporan"><i class="fa fa-circle-o"></i>Cetak Kuisoner</a></li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2016 <a href="https://adminlte.io">Novan Dwi Anggarda</a>.</strong> All rights
    reserved.
  </footer>
