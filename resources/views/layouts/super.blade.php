...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="home" class="logo">
      ...
      <span class="logo-lg"><b>Ikitas</b></span> 
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i> Admin Prov</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> OPD dan Kab/Kota</a></li>
            <li><a href="kabupaten"><i class="fa fa-circle-o"></i> Kabupaten</a></li>
          </ul>
        </li>
        <li>
          <a href="home">
            <i class="fa fa-cart"></i> <span>Berita</span>
          </a>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <li><a href="/about"><i class="fa fa-circle-o text-red"></i> <span>About System</span></a></li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <a href="http://ndanggarda.blogspot.co.id/">Novan Dwi Anggarda</a>.</strong> All rights
    reserved.
  </footer>
